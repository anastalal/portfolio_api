...
class SessionsByCityWidget extends ChartWidget
{
    ...
    protected static ?string $heading = 'Sessions By City';
    ...
    protected function initializeData()
    {
        ...
        foreach ($analyticsData as $row) {
            $results[str($row['region'])->studly()->append(' (' . number_format($row['sessions']) . ')')->toString()] = $row['sessions'];
        }
